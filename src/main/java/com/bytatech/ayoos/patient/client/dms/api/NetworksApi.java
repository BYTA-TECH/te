...
import com.bytatech.ayoos.patient.client.dms.model.PersonNetworkEntry;
import com.bytatech.ayoos.patient.client.dms.model.PersonNetworkPaging;
...
public interface NetworksApi {
    ...
    @ApiOperation(value = "Get a network", nickname = "getNetwork", notes = "Gets information for a network **networkId**.", response = PersonNetworkEntry.class, tags={ "networks", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "Get network information", nickname = "getNetworkForPerson", notes = "Gets network information on a single network specified by **networkId** for **personId**.  You can use the `-me-` string in place of `<personId>` to specify the currently authenticated user. ", response = PersonNetworkEntry.class, tags={ "networks", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response", response = PersonNetworkEntry.class),
        @ApiResponse(code = 401, message = "Authentication failed"),
    ...
    @ApiOperation(value = "List network membership", nickname = "listNetworksForPerson", notes = "Gets a list of network memberships for person **personId**.  You can use the `-me-` string in place of `<personId>` to specify the currently authenticated user. ", response = PersonNetworkPaging.class, tags={ "networks", })
    @ApiResponses(value = { 
