...
import com.bytatech.ayoos.patient.client.dms.model.PreferenceEntry;
import com.bytatech.ayoos.patient.client.dms.model.PreferencePaging;
...
public interface PreferencesApi {
    ...
    @ApiOperation(value = "Get a preference", nickname = "getPreference", notes = "Gets a specific preference for person **personId**.  You can use the `-me-` string in place of `<personId>` to specify the currently authenticated user. ", response = PreferenceEntry.class, tags={ "preferences", })
    @ApiResponses(value = { 
