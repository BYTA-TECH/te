...
import com.bytatech.ayoos.patient.client.dms.model.RenditionEntry;
import com.bytatech.ayoos.patient.client.dms.model.RenditionPaging;
import com.bytatech.ayoos.patient.client.dms.model.SharedLinkBodyCreate;
import com.bytatech.ayoos.patient.client.dms.model.SharedLinkBodyEmail;
import com.bytatech.ayoos.patient.client.dms.model.SharedLinkEntry;
import com.bytatech.ayoos.patient.client.dms.model.SharedLinkPaging;
...
public interface SharedLinksApi {
    ...
    ResponseEntity<SharedLinkEntry> createSharedLink(@ApiParam(value = "The nodeId to create a shared link for." ,required=true )  @Valid @RequestBody SharedLinkBodyCreate sharedLinkBodyCreate,@ApiParam(value = "Returns additional information about the shared link, the following optional fields can be requested: * allowableOperations * path ") @Valid @RequestParam(value = "include", required = false) List<String> include,@ApiParam(value = "A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter. ") @Valid @RequestParam(value = "fields", required = false) List<String> fields);


    @ApiOperation(value = "Deletes a shared link", nickname = "deleteSharedLink", notes = "**Note:** this endpoint is available in Alfresco 5.2 and newer versions.  Deletes the shared link with identifier **sharedId**. ", tags={ "shared-links", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "Get a shared link", nickname = "getSharedLink", notes = "**Note:** this endpoint is available in Alfresco 5.2 and newer versions.  Gets minimal information for the file with shared link identifier **sharedId**.  **Note:** No authentication is required to call this endpoint. ", response = SharedLinkEntry.class, tags={ "shared-links", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response", response = SharedLinkEntry.class),
        @ApiResponse(code = 400, message = "Invalid parameter: **sharedId** is not a valid format "),
        @ApiResponse(code = 404, message = "**sharedId** does not exist "),
    ...
    @ApiOperation(value = "Get shared link content", nickname = "getSharedLinkContent", notes = "**Note:** this endpoint is available in Alfresco 5.2 and newer versions.  Gets the content of the file with shared link identifier **sharedId**.  **Note:** No authentication is required to call this endpoint. ", tags={ "shared-links", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "Get shared link rendition content", nickname = "getSharedLinkRenditionContent", notes = "**Note:** this endpoint is available in Alfresco 5.2 and newer versions.  Gets the rendition content for file with shared link identifier **sharedId**.  **Note:** No authentication is required to call this endpoint. ", tags={ "shared-links", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response"),
        @ApiResponse(code = 206, message = "Partial Content"),
        @ApiResponse(code = 304, message = "Content has not been modified since the date provided in the If-Modified-Since header"),
