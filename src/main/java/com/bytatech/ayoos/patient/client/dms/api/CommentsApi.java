...
import com.bytatech.ayoos.patient.client.dms.model.CommentBody;
import com.bytatech.ayoos.patient.client.dms.model.CommentEntry;
import com.bytatech.ayoos.patient.client.dms.model.CommentPaging;
...
public interface CommentsApi {
    ...
    @ApiOperation(value = "Delete a comment", nickname = "deleteComment", notes = "Deletes the comment **commentId** from node **nodeId**.", tags={ "comments", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "List comments", nickname = "listComments", notes = "Gets a list of comments for the node **nodeId**, sorted chronologically with the newest comment first.", response = CommentPaging.class, tags={ "comments", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "Update a comment", nickname = "updateComment", notes = "Updates an existing comment **commentId** on node **nodeId**.", response = CommentEntry.class, tags={ "comments", })
    @ApiResponses(value = { 
