...
import com.bytatech.ayoos.patient.client.dms.model.SiteBodyCreate;
import com.bytatech.ayoos.patient.client.dms.model.SiteBodyUpdate;
import com.bytatech.ayoos.patient.client.dms.model.SiteContainerEntry;
import com.bytatech.ayoos.patient.client.dms.model.SiteContainerPaging;
import com.bytatech.ayoos.patient.client.dms.model.SiteEntry;
import com.bytatech.ayoos.patient.client.dms.model.SiteMemberEntry;
import com.bytatech.ayoos.patient.client.dms.model.SiteMemberPaging;
import com.bytatech.ayoos.patient.client.dms.model.SiteMembershipApprovalBody;
import com.bytatech.ayoos.patient.client.dms.model.SiteMembershipBodyCreate;
import com.bytatech.ayoos.patient.client.dms.model.SiteMembershipBodyUpdate;
import com.bytatech.ayoos.patient.client.dms.model.SiteMembershipRejectionBody;
import com.bytatech.ayoos.patient.client.dms.model.SiteMembershipRequestBodyCreate;
import com.bytatech.ayoos.patient.client.dms.model.SiteMembershipRequestBodyUpdate;
import com.bytatech.ayoos.patient.client.dms.model.SiteMembershipRequestEntry;
import com.bytatech.ayoos.patient.client.dms.model.SiteMembershipRequestPaging;
import com.bytatech.ayoos.patient.client.dms.model.SiteMembershipRequestWithPersonPaging;
import com.bytatech.ayoos.patient.client.dms.model.SitePaging;
import com.bytatech.ayoos.patient.client.dms.model.SiteRoleEntry;
import com.bytatech.ayoos.patient.client.dms.model.SiteRolePaging;
...
@Api(value = "Sites", description = "the Sites API")
public interface SitesApi {

    @ApiOperation(value = "Approve a site membership request", nickname = "approveSiteMembershipRequest", notes = "Approve a site membership request. ", tags={ "sites", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "Delete a site", nickname = "deleteSite", notes = "**Note:** this endpoint is available in Alfresco 5.2 and newer versions.  Deletes the site with **siteId**. ", tags={ "sites", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "Delete a site membership", nickname = "deleteSiteMembership", notes = "Deletes person **personId** as a member of site **siteId**.  You can use the `-me-` string in place of `<personId>` to specify the currently authenticated user. ", tags={ "sites", })
    @ApiResponses(value = { 
        @ApiResponse(code = 204, message = "Successful response"),
        @ApiResponse(code = 401, message = "Authentication failed"),
        @ApiResponse(code = 404, message = "**siteId** or **personId** does not exist "),
    ...
    @ApiOperation(value = "Delete a site membership", nickname = "deleteSiteMembershipForPerson", notes = "Deletes person **personId** as a member of site **siteId**.  You can use the `-me-` string in place of `<personId>` to specify the currently authenticated user. ", tags={ "sites", })
    @ApiResponses(value = { 
        @ApiResponse(code = 204, message = "Successful response"),
        @ApiResponse(code = 401, message = "Authentication failed"),
    ...
    @ApiOperation(value = "Delete a site membership request", nickname = "deleteSiteMembershipRequestForPerson", notes = "Deletes the site membership request to site **siteId** for person **personId**.  You can use the `-me-` string in place of `<personId>` to specify the currently authenticated user. ", tags={ "sites", })
    @ApiResponses(value = { 
        @ApiResponse(code = 204, message = "Successful response"),
        @ApiResponse(code = 401, message = "Authentication failed"),
        @ApiResponse(code = 404, message = "**personId** or **siteId** does not exist "),
    ...
    @ApiOperation(value = "Get a site container", nickname = "getSiteContainer", notes = "Gets information on the container **containerId** in site **siteId**.", response = SiteContainerEntry.class, tags={ "sites", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "Get a site membership", nickname = "getSiteMembership", notes = "Gets site membership information for person **personId** on site **siteId**.  You can use the `-me-` string in place of `<personId>` to specify the currently authenticated user. ", response = SiteMemberEntry.class, tags={ "sites", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "Get a site membership", nickname = "getSiteMembershipForPerson", notes = "Gets site membership information for person **personId** on site **siteId**.  You can use the `-me-` string in place of `<personId>` to specify the currently authenticated user. ", response = SiteRoleEntry.class, tags={ "sites", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "List site containers", nickname = "listSiteContainers", notes = "Gets a list of containers for the site **siteId**.", response = SiteContainerPaging.class, tags={ "sites", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "List site memberships", nickname = "listSiteMemberships", notes = "Gets a list of site memberships for site **siteId**.", response = SiteMemberPaging.class, tags={ "sites", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "Reject a site membership request", nickname = "rejectSiteMembershipRequest", notes = "Reject a site membership request. ", tags={ "sites", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response"),
        @ApiResponse(code = 400, message = "Invalid parameter: value of **siteId** or **inviteeId** is invalid "),
        @ApiResponse(code = 401, message = "Authentication failed"),
