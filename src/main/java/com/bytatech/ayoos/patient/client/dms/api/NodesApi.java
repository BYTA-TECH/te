...
import com.bytatech.ayoos.patient.client.dms.model.AssociationEntry;
import com.bytatech.ayoos.patient.client.dms.model.ChildAssociationBody;
import com.bytatech.ayoos.patient.client.dms.model.ChildAssociationEntry;
import com.bytatech.ayoos.patient.client.dms.model.Error;
import com.bytatech.ayoos.patient.client.dms.model.NodeAssociationPaging;
import com.bytatech.ayoos.patient.client.dms.model.NodeBodyCopy;
import com.bytatech.ayoos.patient.client.dms.model.NodeBodyCreate;
import com.bytatech.ayoos.patient.client.dms.model.NodeBodyLock;
import com.bytatech.ayoos.patient.client.dms.model.NodeBodyMove;
import com.bytatech.ayoos.patient.client.dms.model.NodeBodyUpdate;
import com.bytatech.ayoos.patient.client.dms.model.NodeChildAssociationPaging;
import com.bytatech.ayoos.patient.client.dms.model.NodeEntry;
...
public interface NodesApi {
    ...
    @RequestMapping(value = "/nodes/{nodeId}/secondary-children",
        ...
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<ChildAssociationEntry> createSecondaryChildAssocation(@ApiParam(value = "The identifier of a parent node.",required=true) @PathVariable("nodeId") String nodeId,@ApiParam(value = "The child node id and assoc type." ,required=true )  @Valid @RequestBody ChildAssociationBody childAssociationBody,@ApiParam(value = "A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter. ") @Valid @RequestParam(value = "fields", required = false) List<String> fields);


    @ApiOperation(value = "Delete node association(s)", nickname = "deleteAssocation", notes = "**Note:** this endpoint is available in Alfresco 5.2 and newer versions.  Delete an association, or associations, from the source **nodeId* to a target node for the given association type.  If the association type is **not** specified, then all peer associations, of any type, in the direction  from source to target, are deleted.  **Note:** After removal of the peer association, or associations, from source to target, the two nodes may still have peer associations in the other direction. ", tags={ "nodes", })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/nodes/{nodeId}/secondary-children/{childId}",
        produces = "application/json", 
        method = RequestMethod.DELETE)
    ResponseEntity<Void> deleteSecondaryChildAssocation(@ApiParam(value = "The identifier of a parent node.",required=true) @PathVariable("nodeId") String nodeId,@ApiParam(value = "The identifier of a child node.",required=true) @PathVariable("childId") String childId,@ApiParam(value = "Only delete associations of this type.") @Valid @RequestParam(value = "assocType", required = false) String assocType);


    @ApiOperation(value = "Get a node", nickname = "getNode", notes = "**Note:** this endpoint is available in Alfresco 5.2 and newer versions.  Get information for node **nodeId**.  You can use the **include** parameter to return additional information. ", response = NodeEntry.class, tags={ "nodes", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "List secondary children", nickname = "listSecondaryChildren", notes = "**Note:** this endpoint is available in Alfresco 5.2 and newer versions.  Gets a list of secondary child nodes that are associated with the current parent **nodeId**, via a secondary child association. ", response = NodeChildAssociationPaging.class, tags={ "nodes", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response", response = NodeChildAssociationPaging.class),
        @ApiResponse(code = 400, message = "Invalid parameter: **assocType** is unknown or the **nodeId** is not a valid format "),
        @ApiResponse(code = 401, message = "Authentication failed"),
    ...
    @ApiOperation(value = "List source associations", nickname = "listSourceAssociations", notes = "**Note:** this endpoint is available in Alfresco 5.2 and newer versions.  Gets a list of source nodes that are associated with the current target **nodeId**. ", response = NodeAssociationPaging.class, tags={ "nodes", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response", response = NodeAssociationPaging.class),
    ...
    @ApiOperation(value = "List target associations", nickname = "listTargetAssociations", notes = "**Note:** this endpoint is available in Alfresco 5.2 and newer versions.  Gets a list of target nodes that are associated with the current source **nodeId**. ", response = NodeAssociationPaging.class, tags={ "nodes", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response", response = NodeAssociationPaging.class),
        @ApiResponse(code = 400, message = "Invalid parameter: **assocType** is unknown or the **nodeId** is not a valid format "),
        @ApiResponse(code = 401, message = "Authentication failed"),
