...
import com.bytatech.ayoos.patient.client.dms.model.DownloadBodyCreate;
import com.bytatech.ayoos.patient.client.dms.model.DownloadEntry;
...
public interface DownloadsApi {
    ...
    @ApiOperation(value = "Get a download", nickname = "getDownload", notes = "**Note:** this endpoint is available in Alfresco 5.2.1 and newer versions.  Retrieve status information for download node **downloadId** ", response = DownloadEntry.class, tags={ "downloads", })
    @ApiResponses(value = { 
