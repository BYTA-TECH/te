...
import com.bytatech.ayoos.patient.client.dms.model.Capabilities;
import com.bytatech.ayoos.patient.client.dms.model.Company;
...
public class Person   {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, firstName, lastName, description, avatarId, email, skypeId, googleId, instantMessageId, jobTitle, location, company, mobile, telephone, statusUpdatedAt, userStatus, enabled, emailNotificationsEnabled, aspectNames, properties, capabilities);
  }
