...
import com.bytatech.ayoos.patient.client.dms.model.ActivityPaging;
...
public interface ActivitiesApi {
    ...
    @ApiOperation(value = "List activities", nickname = "listActivitiesForPerson", notes = "Gets a list of activities for person **personId**.  You can use the `-me-` string in place of `<personId>` to specify the currently authenticated user. ", response = ActivityPaging.class, tags={ "activities", })
    @ApiResponses(value = { 
