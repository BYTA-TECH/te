...
@RestController
@RequestMapping("/api/patient-kafka")
public class PatientKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PatientKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PatientKafkaResource(KafkaProperties kafkaProperties) {
